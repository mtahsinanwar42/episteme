...
- Display a paginated list of activities for public users.
- Allow navigation to an activity detail page.
- Allow ADMIN to navigate to create a new activity.
...
- Card click navigates to: `/activities/:id`
...
- If role includes `ADMIN`, show:
  - “New Activity” action button → `/activities/new`
