    ...
    <section className="mb-20">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border-2 border-purple-500 dark:border-purple-700 hover:shadow-lg transition-shadow">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border-2 border-pink-500 dark:border-pink-700 hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">⚡</div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border-2 border-orange-500 dark:border-orange-700 hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🌍</div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border-2 border-red-500 dark:border-red-700 hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🤝</div>
