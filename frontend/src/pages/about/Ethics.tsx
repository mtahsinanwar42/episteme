  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="mb-20">
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-12">
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border-t-4 border-indigo-500">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border-t-4 border-purple-500">
            <div className="text-5xl mb-4">🤝</div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border-t-4 border-pink-500">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border-t-4 border-rose-500">
            <div className="text-5xl mb-4">✅</div>
