...
export default function AllReviewAssignments() {
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="text-sm">
            <div>
              {row.original.reviewerFirstName}{" "}
              {row.original.reviewerLastName}
            </div>
            <div className="text-muted-foreground text-xs">
  ...
  return (
    <div>
      <Breadcrumb
        items={[
          { label: "Review Assignments", href: "/review-assignments" },
        ]}
      />
      <div className="mb-6 flex justify-between items-end">
        <div>
          <PageTitle title="Review Assignments" />
          <PageSubTitle text="View and manage all reviewer assignments" />
        </div>
        <Button
          variant="outline"
      ...
      <ReviewAssignmentStatusUpdateModal
        ...
        canUpdateStatus={
          selectedAssignment ? canAdminUpdateStatus(selectedAssignment) : false
        }
      />
    </div>
  );
